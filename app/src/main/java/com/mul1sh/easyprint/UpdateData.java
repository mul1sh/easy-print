...
import com.mul1sh.easyprint.networksync.ChangePhotoRequest;
import com.mul1sh.easyprint.networksync.CheckInternetConnection;
import com.mul1sh.easyprint.networksync.UpdateRequest;
...
public class UpdateData extends AppCompatActivity {
    ...
    private boolean validateEmail() {
        ...
        if (check.length() < 4 || check.length() > 40) {
            ...
            return false;
        } else return check.contains("@") && check.contains(".");
